...
const int MAX_TABLES_PER_DATE = 20;
...
//Verifies whether the reservation time falls within the restaurant’s operating hours.
...
a reservation with the same date and a status of “Confirmed” is found.*/
   ...
   do {
    ...
    break;
            ...
            case 5:
                ...
                break;
            case 6:
                cout << "Enter receipt number, new date, and new time: ";
                cin >> receipt >> date >> time;
                if (!rrs.isValidDate(date)) {
